...
class Robot():
    ...
    def powerControl(self, powerOn, stand=False):
        if not stand and self.powerState:
    ...
    def __upload_graph_and_snapshots(self, *args):
        ...
        response = self.graph_nav_client.upload_graph(graph=self._current_graph, generate_new_anchoring=true_if_empty)
    ...
    def _navigate_to_anchor(self, x, y, z=0):        
        ...
        while not is_finished:
            ...
            try:
                ...
                break
            sleep(.5)  # Sleep for half a second to allow for command execution.
